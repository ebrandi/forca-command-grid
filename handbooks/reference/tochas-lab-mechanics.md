...
yet applied); smartbombs, mining yield and DoT (breacher-pod) weapons; booster side-effects.
(Fleet command bursts, incoming ewar, neut/nos pressure and remote reps *are* now modelled —
see "Fleet boosts" and "Projected effects" above.) **Environmental / abyssal-weather effects
