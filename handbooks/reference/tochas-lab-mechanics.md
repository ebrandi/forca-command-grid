...
Fighters and fighter tubes; **projected ECM onto us** (a hostile jammer breaking *our* lock is
...
loss). (Smartbombs, vorton projectors, breacher-pod DoT and mining yield *are* now modelled —
